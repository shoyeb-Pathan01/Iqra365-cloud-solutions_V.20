...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Specialist Microsoft Security & Cloud consultancy for Indian mid-market companies. Entra ID, Intune, Defender, Purview, Azure Sentinel, M365 Operations. Founded by certified M365 practitioners." },
      { property: "og:site_name", content: "Iqra365 Cloud Solutions" },
      { property: "og:type", content: "website" },
      { property: "og:title", content: "Iqra365 Cloud Solutions — Microsoft Security & Cloud Consultancy" },
      { property: "og:description", content: "Specialist Microsoft Security & Cloud consultancy for Indian mid-market companies." },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Iqra365 Cloud Solutions — Microsoft Security & Cloud Consultancy" },
      { name: "twitter:description", content: "Specialist Microsoft Security & Cloud consultancy for Indian mid-market companies." },
    ],
    links: [
